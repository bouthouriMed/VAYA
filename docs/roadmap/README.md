...
**Recommended next phase:** **Phase 6 — Pricing Engine.** Phase 5 completed the ride engine (stop-aware matching, real passenger stop selection, server-enforced pickup integrity); Phase 6 is next per the roadmap's own sequencing logic — pricing is the other hard, NOW-horizon mechanic the task brief calls out, and nothing later strictly depends on Phase 5 beyond it already being done.
